classdef PostTrees < handle
	properties
		...
		trees; % a map<snope_id, tree object>
	...
	methods
	 ...
	 %    end
	 	...
	 	% from v3
  		function print(self)
	        fprintf('                         snope_id               size       depth    breadth at 2    breadth at 3 \n');
	        fprintf('----------------------------------------------------------------------------------------------------\n');
	        for (i=1:self.nTrees)
